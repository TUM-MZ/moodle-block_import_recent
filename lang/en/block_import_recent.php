...
/**
 * Strings for component 'block_import_recent', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_import_recent
 * @copyright 1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.import_recent GNU GPL v3 or later
 */
...
$string['import_recent:addinstance'] = 'Add a new HTML block';
$string['import_recent:myaddinstance'] = 'Add a new HTML block to Dashboard';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['importblocktitle'] = 'Import A Recent Course';
...
$string['import_course_from'] = 'Import course content from';
